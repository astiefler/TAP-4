...
class ProbabilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create probability" do
    assert_difference('Probability.count') do
      post probabilities_url, params: { probability: { age_range_id: @probability.age_range_id, death: @probability.death, gender_id: @probability.gender_id, population: @probability.population, probability: @probability.probability, state_id: @probability.state_id } }
    end
  ...
  test "should update probability" do
    patch probability_url(@probability), params: { probability: { age_range_id: @probability.age_range_id, death: @probability.death, gender_id: @probability.gender_id, population: @probability.population, probability: @probability.probability, state_id: @probability.state_id } }
