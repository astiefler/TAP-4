...
class BloodTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blood_type" do
    assert_difference('BloodType.count') do
      post blood_types_url, params: {blood_type: {blood_type_desc: @blood_type.blood_type_desc}}
    end
  ...
  test "should update blood_type" do
    patch blood_type_url(@blood_type), params: {blood_type: {blood_type_desc: @blood_type.blood_type_desc}}
